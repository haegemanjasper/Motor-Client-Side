...
import { KAWA_DETAILS } from "../../api/mock_data.js";
import { useState } from "react";

const KawaDetails = () => {
  const [motorDetails, setMotorDetails] = useState(KAWA_DETAILS);
  ...
  const handleAddMotorDetail = (id) => {
    const motorToAdd = KAWA_DETAILS.find((motor) => motor.id === id);
