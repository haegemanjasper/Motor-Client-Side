...
import { HONDA_DETAILS } from "../../api/mock_data.js";
import { useState } from "react";

const HondaDetails = () => {
  const [motorDetails, setMotorDetails] = useState(HONDA_DETAILS);
  ...
  const handleAddMotorDetail = (id) => {
    const motorToAdd = HONDA_DETAILS.find((motor) => motor.id === id);
