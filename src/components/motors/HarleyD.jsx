...
import { HARLEYD_DETAILS } from "../../api/mock_data.js";
import { useState } from "react";

const HarleyDetails = () => {
  const [motorDetails, setMotorDetails] = useState(HARLEYD_DETAILS);
  ...
  const handleAddMotorDetail = (id) => {
    const motorToAdd = HARLEYD_DETAILS.find((motor) => motor.id === id);
