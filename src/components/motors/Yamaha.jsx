...
import { YAMAHA_DETAILS } from "../../api/mock_data.js";
import { useState } from "react";

const YamahaDetails = () => {
  const [motorDetails, setMotorDetails] = useState(YAMAHA_DETAILS);
  ...
  const handleAddMotorDetail = (id) => {
    const motorToAdd = YAMAHA_DETAILS.find((motor) => motor.id === id);
